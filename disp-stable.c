...
#include "disp-stable.h"
#include "error-messages.h"

static void disp_sampled_table_free(struct disp_struct *d);
static struct disp_struct * \
disp_sampled_table_copy(struct disp_struct *d);

static cmpl disp_sampled_table_n_value(const disp_t *disp, double lam);

struct disp_class disp_sampled_table_class = {
    .disp_class_id       = DISP_SAMPLED_TABLE,
    .model_id            = MODEL_NONE,

    .short_id            = "SampledTable",
    .full_id             = "SampledTableDispersion",

    .free                = disp_sampledtable_free,
    .copy                = disp_sampled_table_copy,

    .n_value             = disp_sampled_table_n_value,
    .fp_number           = NULL,
    .n_value_deriv       = NULL,
    .apply_param         = NULL,
