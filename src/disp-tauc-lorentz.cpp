...
tauc_lorentz_n_value_deriv(const disp_t *d, double lambda, cmpl_vector *pd)
{
    ...
    for (int osc_index = TL_OSC_OFFS, k = 0; k < nb; k++, osc_index += TL_NB_OSC_PARAMS) {
        ...
        double x0 = std::pow(eg, 2);
        double x1 = std::pow(en, 2);
        double x2 = x0 + x1;
        double x3 = 1.0/M_PI;
        double x4 = 1.0/en;
        double x5 = eg + en;
        ...
        bool   x8 = (en > eg);
        double x9 = eg - en;
        double x10 = x8 ? log(x7) : log(x9);
        double x11 = x10 - x6;
        double x12 = std::pow(c, 2);
        double x13 = -x12;
        double x14 = std::pow(e0, 2);
        double x15 = x13 + 4*x14;
        double x16 = -x14;
        double x17 = x1 + x16;
        double x18 = (1.0L/2.0L)*x12 + x17;
        double x19 = (1.0L/4.0L)*x12*x15 + std::pow(x18, 2);
        double x20 = 1.0/x19;
        double x21 = a*c*x11*x20*x3*x4;
        double x22 = x2*x21;
        double x23 = 2*e0*eg;
        double x24 = x0*x12;
        double x25 = -x0 + x14;
        double x26 = x24 + std::pow(x25, 2);
        double x27 = x10 + x6 - log(std::sqrt(x26));
        double x28 = a*c*x20*x27*x3;
        double x29 = std::sqrt(x15);
        double x30 = 1.0/x29;
        double x31 = 1.0/c;
        double x32 = -2*x0 + x13 + 2*x14;
        double x33 = x30*x32;
        double x34 = 2*atan(x31*x33) + M_PI;
        double x35 = a*x18*x20*x3*x30*x34;
        double x36 = x0 + x14;
        double x37 = x17*x36 + x24;
        double x38 = 1.0/e0;
        double x39 = 2*eg;
        double x40 = x29 - x39;
        double x41 = x29 + x39;
        double x42 = atan(x31*x40) - atan(x31*x41) + M_PI;
        double x43 = a*x20*x3*x38*x42;
        double x44 = x0 + x16;
        double x45 = 3*x0 + x14;
        double x46 = x1*x44 - x14*x45 + x24;
        double x47 = eg*x29;
        double x48 = x36 + x47;
        double x49 = x36 - x47;
        double x50 = 1.0/x49;
        double x51 = log(x48*x50);
        double x52 = (1.0L/2.0L)*a*c*x20*x3*x30*x38*x51;
        double x53 = std::pow(x7, 2);
        double x54 = x1*x12 + std::pow(x17, 2);
        double x55 = 1.0/x54;
        double x56 = a*x4*x53*x55;
        double x57 = c*x56;
        double x58 = a*e0*x20*x3;
        double x59 = 1.0/x5;
        double x60 = x8 ? -1/x7 : 1.0/x9;
        double x61 = 2*e0;
        double x62 = 2*a*e0*x20*x3*x34;
        double x63 = x12*x39;
        double x64 = 1.0/x26;
        double x65 = 1.0/x15;
        double x66 = 1.0/x12;
        double x67 = 1.0/(std::pow(x32, 2)*x65*x66 + 1);
        double x68 = 2*x31;
        double x69 = 1.0/(std::pow(x40, 2)*x66 + 1);
        double x70 = 1.0/(std::pow(x41, 2)*x66 + 1);
        double x71 = a*x20*x3*x37*x38;
        double x72 = x48/std::pow(x49, 2);
        double x73 = (1.0L/2.0L)*a*c*x20*x3*x30*x38*x46*x49/x48;
        double x74 = x20*x3;
        double x75 = 2*e0*eg*x18*x30*x34;
        double x76 = x37*x38*x42;
        double x77 = (1.0L/2.0L)*c*x30*x38*x46*x51;
        double x78 = 4*eg*x14;
        double x79 = 4*e0*x18 - x12*x61;
        double x80 = std::pow(x19, -2);
        double x81 = a*c*e0*x11*x2*x3*x4*x80;
        double x82 = std::pow(x15, -3.0L/2.0L);
        double x83 = a*x20*x3*x34*x82;
        double x84 = a*x20*x3/x14;
        double x85 = 2*a*c*e0*eg*x27*x3*x80;
        double x86 = a*x3*x79*x80;
        double x87 = x46*x51*x82;
        double x88 = 4*e0*x30;
        double x89 = x31*x88;
        double x90 = x32*x82;
        double x91 = 4*a*e0*eg*x18*x20*x3*x30*x67;
        double x92 = eg*x88;
        double x93 = c*eg*x30;
        double x94 = a*x20*x3*x30*x38*x51;
        double x95 = (1.0L/2.0L)*std::pow(c, 3) - 1.0L/2.0L*c*x15 - 2*c*x18;
        double x96 = a*x3*x80*x95;
        double x97 = -x30;
        double x98 = c*e0*x4*x55;
        double x99 = std::pow(x54, -2);
        ...
        const double d_eg_imag = (x8 ? a*x98*(-2*en + x39) : 0);
        ...
        const double d_a_imag = (x8 ? x53*x98 : 0);
        ...
        const double d_e0_imag = (x8 ? 4*a*c*x14*x17*x4*x53*x99 + x57 : 0);
        ...
        const double d_c_imag = (x8 ? -2*a*e0*en*x12*x53*x99 + e0*x56 : 0);
