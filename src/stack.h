...
extern void     stack_get_ns_list(const stack_t *s, cmpl *ns, double lambda);
extern void     stack_get_all_parameters(const stack_t *s, struct fit_parameters *fps, unsigned int scope);
