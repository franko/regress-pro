...
cmpl tauc_lorentz_n_value_deriv(const disp_t *d, double lambda,
  ...
  for (int osc_index = TL_OSC_OFFS, k = 0; k < nb;
    ...
    er_sum +=
        ((x23) ? (-a * x22) : (x25 * x40)) + ((x78) ? (a * x77) : (a * x87));
    ei_sum += ((x28) ? (a * x92) : (0));

    const double d_eg_real =
        ((x78) ? (x116 * (-c * x108 * x44 * x73 - x101 * x99 + x102 * x53 -
    ...
    const double d_e0_real =
        ...
        ((x78) ? (x126 * x151 *
                  (-c * x140 * x141 +
                   ...
                   x105 * x107 * x129 * x147 * x16 * (x148 + 1) - x124 * x149 -
                   x131 * x136 * x43 - x135 * x139 * x16 - x135 * x43 +
                   x136 * x44 + x137 * x138 + x137 * x142 * x58 + x137 * x150 -
                   x142 * x149 - 4 * x145 * x146 +
                   8 * x49 * x57 * (x109 - 1 / (x104 * std::pow(x143, 2) + 1))))
               : (x133 *
    ...
    const double d_c_real =
        ((x78)
             ? (x116 *
                (c * x139 * x38 * x53 - eg * x113 * x147 * x161 * (x72 + 1) +
                 x106 * x147 * x159 * (-x104 * x47 + x148 + 2) -
                 x141 * x3 * x59 + x146 * x161 + x154 * x162 * x43 * x53 +
                 x159 * x20 * x43 * x51 - x160 * x99 - x163 * x65 + x164 * x75 -
                 x58 * x59 *
                     (-x109 * (x104 * x60 + x43) + x110 * (x104 * x143 + x43)) +
                 x75))
        ...
        ((x23) ? (e0 * x128 * (-x156 * x9 - x3 * x93 + x8))
               : (e0 * x133 *
                  (-16 * eg * x156 * x37 + x1 * x122 * x31 * x33 * x96 + x132 -
                   x158 * x93)));
