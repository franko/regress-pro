...
void agg_plot<VS,RM>::commit_pending_draw()
{
  push_drawing_queue();
  m_need_redraw = false;
}
...
template <class VS, class RM>
void agg_plot<VS,RM>::add(VS* vs, agg::rgba8& color, bool outline) 
{ 
...
template <class VS, class RM>
void agg_plot<VS,RM>::set_title(const char *text) 
{
...
template <class VS, class RM>
void agg_plot<VS,RM>::push_drawing_queue() 
{
...
template <class VS, class RM>
void agg_plot<VS,RM>::clear_drawing_queue() 
{
  while (m_drawing_queue)
    {
...
template <class VS, class RM>
void agg_plot<VS,RM>::draw(canvas &canvas, agg::trans_affine& canvas_mtx)
{
  before_draw();
...
template <class VS, class RM>
void agg_plot<VS,RM>::draw_title(canvas &canvas, agg::trans_affine& canvas_mtx)
{
  double xt = 0.5, yt = 1;
...
template<class VS, class RM>
void agg_plot<VS,RM>::draw_element(item& c, canvas &canvas, agg::trans_affine& m)
{
...
template<class VS, class RM>
agg::trans_affine agg_plot<VS,RM>::get_scaled_matrix(agg::trans_affine& canvas_mtx)
{
...
template<class VS, class RM>
void agg_plot<VS,RM>::clip_plot_area(canvas &canvas, agg::trans_affine& canvas_mtx)
{
...
template<class VS, class RM>
void agg_plot<VS,RM>::draw_elements(canvas &canvas, agg::trans_affine& canvas_mtx)
{
...
template<class VS, class RM>
void agg_plot<VS,RM>::draw_queue(canvas &canvas, agg::trans_affine& canvas_mtx,
			     opt_rect<double>& bb)
{
  typedef typename agg_plot<VS,RM>::iterator iter_type;
...
template<class VS, class RM>
void agg_plot<VS,RM>::compute_user_trans()
{
...
template <class VS, class RM>
void agg_plot<VS,RM>::draw_axis(canvas &canvas, agg::trans_affine& canvas_mtx)
{
...
template<class VS, class RM>
void agg_plot<VS,RM>::viewport_scale(agg::trans_affine& m)
{
...
template<class VS, class RM>
void agg_plot<VS,RM>::set_units(bool use_units)
{ 
...
template<class VS, class RM>
void agg_plot<VS,RM>::set_limits(const agg::rect_base<double>& r)
{
  m_rect.set(r);
...
template<class VS, class RM>
void agg_plot<VS,RM>::layer_dispose_elements(agg_plot<VS,RM>::item_list& layer)
{
...
template<class VS, class RM>
bool agg_plot<VS,RM>::push_layer()
{
...
template <class VS, class RM>
void agg_plot<VS,RM>::clear_current_layer() 
{
  clear_drawing_queue();
...
template <class VS, class RM>
int agg_plot<VS,RM>::current_layer_index()
{
